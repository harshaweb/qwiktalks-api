...
export const register = async (req, res) => {
  ...
  try {
    ...
    try {
      await aisensyService.createBusiness({
      ...
      console.log('[Auth Controller] Aisensy business created for user:', newUser._id.toString());
    } catch (aisensyError) {
      console.error('[Auth Controller] Aisensy business creation failed (non-blocking):', aisensyError.message);
    }
